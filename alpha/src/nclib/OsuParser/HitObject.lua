nclib.OsuParser.HitObject = createClass()
local HitObject = nclib.OsuParser.HitObject

HitObject.parse = function(self, line)
	self.lineTable = line:split(",")
...
HitObject.updateKey = function(self)
