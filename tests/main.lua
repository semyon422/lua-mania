...
function love.load()
	...
	data.audio = love.audio.newSource(data.pathprefix .. "click.wav")
	--data.joysticks = love.joystick.getJoysticks()
	--data.joystick = joysticks[1]
	
	data.cursor = love.graphics.newImage(data.pathprefix .. "cursor.png")
	data.star = love.graphics.newImage(data.pathprefix .. "star.png")
